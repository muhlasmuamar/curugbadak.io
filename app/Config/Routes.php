...
$routes->get('Ob_wisata', 'Wisata::index');

$routes->group('admin', function ($routes) {
    $routes->add('/', 'admin\Home::index');
    $routes->get('home', 'admin\Home::index');
    $routes->add('wisata', 'admin\Wisata::index');
    $routes->add('wisata/add', 'admin\Wisata::add');
    $routes->add('wisata/save', 'admin\Wisata::save');
    $routes->add('wisata/edit/(:segment)', 'admin\Wisata::edit/$1');
    $routes->add('wisata/update', 'admin\Wisata::update');
    $routes->add('wisata/delete/(:segment)', 'admin\Wisata::delete/$1');
    ...
    $routes->add('petugas/add', 'admin\Petugas::add');
    ...
    $routes->add('petugas/update', 'admin\petugas::update');
});
